...
def remove_whitelisted(list_of_handshakes, list_of_whitelisted_strings, valid_on_error=True):
    ...
    # Bolt: Pre-calculate normalized whitelists to avoid O(N*M) loop invariant recalculation
    normalized_whitelists = [normalize(whitelist) for whitelist in list_of_whitelisted_strings]
