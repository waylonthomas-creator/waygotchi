...
def _888_to_565(bt):
    # Performance optimization: pre-allocate bytearray to avoid O(N^2) memory reallocation
    # and use direct bitwise assignment instead of int.to_bytes to significantly speed up
    # the pure Python conversion path.
    length = len(bt)
