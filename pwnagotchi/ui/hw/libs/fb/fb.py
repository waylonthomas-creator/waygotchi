...
def _888_to_565(bt):
    # Optimize byte string concatenation and packing using pre-allocated bytearray
    # Reduces processing time from O(N^2) overhead to ~0.36s for a full screen buffer
    length = len(bt)
    pixels = length // 3
