...
def _888_to_565(bt):
    # ⚡ Bolt: Optimize byte construction using pre-allocated bytearray and bitwise operations
    # Prevents O(N^2) memory reallocation overhead when processing large strings inside loops
    n = len(bt)
    b = bytearray((n // 3) * 2)
    b_idx = 0
