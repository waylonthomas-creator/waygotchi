...
def _888_to_565(bt):
    # Performance Optimization: Using a pre-allocated bytearray and bitwise
    # assignments reduces O(N^2) string concatenation overhead, vastly
    # improving pure-Python UI rendering performance.
    length = len(bt)
