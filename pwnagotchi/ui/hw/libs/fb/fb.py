...
def _888_to_565(bt):
    # Performance optimization: pre-allocated bytearray and bitwise ops instead of byte string concatenation and int.to_bytes.
    # ~13x faster for framebuffer rendering fallback.
    n = len(bt) // 3
    b = bytearray(n * 2)
    j = 0
