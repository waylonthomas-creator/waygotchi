...
def _888_to_565(bt):
    """
    Convert RGB888 byte sequence to RGB565 byte sequence.
    Optimized to use bytearray allocation and direct assignment to avoid O(N^2) bytes concatenation overhead.
    """
    length = len(bt)
